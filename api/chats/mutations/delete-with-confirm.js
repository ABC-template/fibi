...
// Версия: 2.0.0 - убрана зависимость от user_devices и pending_deletions
// ============================================
 ...
 */
async function deleteChatHard(userId, chatId, config) {
    try {
        ...
        console.error('Delete chat hard error:', err.message);
 ...
 */
async function deleteMessageHard(userId, messageId, config) {
    try {
        ...
        console.error('Delete message hard error:', err.message);
        return { success: false, error: err.message };
    }
}
