...
import { getSupabaseConfig, supabaseFetch, canUserSync, getUserUuid } from '../../_lib/supabase-client.js';
 ...
 */
async function batchAddMessages(userId, userUuid, chatId, messages, config) {
    try {
        isValidUUID(chatId, 'Chat ID');
 ...
 */
async function createChatWithBatch(userId, userUuid, chatData, messages, config) {
    try {
