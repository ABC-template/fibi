...
// Версия: 3.4.0 - СРАВНЕНИЕ sync_token и генерация нового при несовпадении
// ============================================

import { authenticate } from '../_lib/auth.js';
import { corsHeaders, handleCORS, jsonResponse, errorResponse } from '../_lib/cors.js';
import { getSupabaseConfig, supabaseFetch, getOrCreateAuthUser, getSyncToken, updateSyncToken } from '../_lib/supabase-client.js';
...
export default async function handler(request) {
    ...
    try {
        ...
        try {
            ...
            return errorResponse('Ошибка авторизации: ' + err.message, 500);
        }
