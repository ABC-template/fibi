...
class ThemeManager {
    constructor() {
        this.supportedThemes = ['light', 'amoled'];  // ← Убрали 'dark'
    ...
    detectTelegramTheme() {
        ...
        // Если в Telegram темная тема → включаем AMOLED
...
console.log('✅ ThemeManager загружен и создан (только light/amoled)');
