// ============================================
// js/store/TasksStore.js
// Описание: Хранилище заданий, баланса, прогресса
// Версия: 2.1.0 - ДОБАВЛЕНА ГЕНЕРАЦИЯ СОБЫТИЙ
// ============================================
...
class TasksStore extends BaseStore {
    ...
    addBalance(amount, reason = 'Награда') {
    ...
    spendBalance(amount, reason = 'Трата') {
    ...
    addTokens(amount, reason = 'Покупка') {
...
window.tasksStore = new TasksStore();

console.log('✅ TasksStore v2.1.0 загружен (с генерацией событий)');
