...
// Описание: Модуль органайзера (полноценный раздел)
// Версия: 2.1.0 - ДОБАВЛЕН BACKBUTTON
// ============================================
...
class OrganizerModule {
    ...
    async init() {
        ...
        this.container.innerHTML = `
            <div style="padding: 16px; flex:1; overflow-y:auto; padding-bottom: 80px;">
                ...
                <!-- To-Do -->
                <div id="organizer-todo" style="background:var(--app-bg-secondary); padding:16px; border-radius:16px; border:1px solid var(--app-border-color-light); margin-bottom:16px;">
                    ...
                    <div id="organizer-todo-list" style="display:flex; flex-direction:column; gap:8px; max-height:220px; overflow-y:auto;"></div>
                </div>
                
                <!-- Напоминания -->
                <div id="organizer-reminders" style="background:var(--app-bg-secondary); padding:16px; border-radius:16px; border:1px solid var(--app-border-color-light); margin-bottom:16px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                    ...
                    <div id="organizer-reminder-list" style="display:flex; flex-direction:column; gap:8px; max-height:180px; overflow-y:auto;"></div>
                </div>
                
                <!-- Трекеры -->
                <div id="organizer-trackers" style="background:var(--app-bg-secondary); padding:16px; border-radius:16px; border:1px solid var(--app-border-color-light);">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                    ...
                    <div id="organizer-tracker-list" style="display:flex; flex-direction:column; gap:12px;"></div>
                </div>
            </div>
        `;
        ...
        console.log('✅ OrganizerModule инициализирован');
    }
    ...
    show() {
        ...
        // Если форма трекера открыта — показываем BackButton
        const form = document.getElementById('organizer-tracker-form');
        if (form?.style.display === 'flex') {
            this._showBackButton();
            this._isInFeature = true;
...
// ✅ ПРАВИЛЬНО: экспортируем класс (НЕ экземпляр!)
window.OrganizerModule = OrganizerModule;

console.log('✅ OrganizerModule v2.1.0 загружен');
